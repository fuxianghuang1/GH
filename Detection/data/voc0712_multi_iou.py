...
class VOCDetection2(data.Dataset):
    ...
    def evaluate_detections2(self, all_boxes, output_dir=None):
        ...
        self._do_python_eval_multi_ious(output_dir)
    ...
    def _do_python_eval_multi_ious(self, output_dir='output'):
        ...
        for ious in range(50,100,5):
            ...
            for i, cls in enumerate(VOC_CLASSES):
                ...
                rec, prec, ap = voc_eval(
                                    filename, annopath, imagesetfile, cls, cachedir, ovthresh=(ious/100),
                                    use_07_metric=use_07_metric)

                aps += [ap]
            ap_ious.append(np.array(aps))
            ap_ious_avg.append(np.mean(aps))
            print(ious/100)
        ...
        print('ao_ious_all = {}'.format(ap_ious))
        print('Mean AP_ious = {}'.format(ap_ious_avg))
        print('Mean AP_ious_avg0.5_0.95={}'.format(np.mean(ap_ious_avg)))
        print('~~~~~~~~')
        print('--------------------------------------------------------------')
