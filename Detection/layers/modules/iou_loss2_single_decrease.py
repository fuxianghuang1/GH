...
class iou_2loss_single_decrease(nn.Module):
    def __init__(self):
        super(iou_2loss_single_decrease, self).__init__()
        self.variance = [0.1,0.2]
    def forward(self, pred, target,alph, priors_iou, decrease):
        ...
        ada_loss_ious=(1.0-ious+decrease*ious-decrease*ious**2)*alph
        #print(ada_loss_ious)
