...
class YIOULoss(nn.Module):
    def __init__(self):
        super(YIOULoss, self).__init__()
        self.variance = [0.1,0.2]
    def forward(self, pred, target, priors_iou):
        decoded_boxes=decode_pred_yiou(pred,priors_iou,self.variance)
