...
def score_label(input_image,targets):
    #t0=time.time()
    ...
    for idx in range(n):
        ...
        areas1=((-bareas[0])>0).nonzero()#select bare
...
def downsample(input_image,targets,width,height,steps):
    #print(input_image.type)
    score_label1=score_label(input_image,targets)
