...
class LeNet(nn.Sequential):
    def __init__(self, num_classes=10):
        ...
        self.fc.apply(init_weights)
        self.gvbg = nn.Linear(500, num_classes)
        self.gvbg.apply(init_weights)
...
class DTN(nn.Sequential):
    def __init__(self, num_classes=10):
        ...
        self.fc.apply(init_weights)
        self.gvbg = nn.Linear(512, num_classes)
        self.gvbg.apply(init_weights)
...
class generator_mcd(nn.Module):
    def __init__(self):
        super(generator_mcd, self).__init__()
